...
export default function LegalPage({ title, updated, sections }: LegalPageProps) {
  return (
    <section className="bg-slate-50 pt-[8.75rem] pb-16 sm:pt-[10rem] lg:pt-[11.5rem] lg:pb-24">
      <div className="container-page max-w-3xl">
        <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl">
          {title}
        </h1>
        {updated ? <p className="mt-4 text-sm text-slate-400">Редакция от {updated}</p> : null}
