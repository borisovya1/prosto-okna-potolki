...
export default function CookieConsent() {
  ...
  return (
    ...
    >
      <div className="rounded-2xl border border-slate-200 bg-slate-50/95 p-5 shadow-xl shadow-slate-900/15 backdrop-blur-md">
        <p className="text-base font-bold text-slate-900">Мы используем файлы cookie</p>
        ...
        {requested ? (
          <button
            ...
            className="mt-3 w-full text-center text-xs font-semibold text-slate-500 transition hover:text-slate-900"
          >
